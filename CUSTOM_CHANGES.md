...
## Last Upstream Sync
- Date: 2026-02-03
- Upstream Commit: e3b85b982 (fix: shell completion and drop onboarding prompt)
- Conflicts Resolved: 
  - `src/agents/pi-embedded-runner/extra-params.ts` - Merged upstream's CacheRetentionStreamOptions with custom thinking support
